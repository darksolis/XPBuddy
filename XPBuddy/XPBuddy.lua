...
local function ApplyAppearance()
  ...
  f:SetScale(XPBuddyDB.scale or 1)
  f.lockIcon:SetShown(XPBuddyDB.locked)
  f:EnableMouse(not XPBuddyDB.locked)
end
...
panel.sub:SetText("Professional XP HUD controls")
...
lockCB:SetPoint("TOPLEFT",panel.sub,"BOTTOMLEFT",0,-14)
...
local scaleSL=Slider(panel,"XPBuddyScaleSlider","HUD Scale",0.8,1.5,0.05)
scaleSL:SetPoint("TOPLEFT",autoCB,"BOTTOMLEFT",0,-28)
local fontSL=Slider(panel,"XPBuddyFontSlider","Font Size",10,18,1)
fontSL:SetPoint("TOPLEFT",scaleSL,"BOTTOMLEFT",0,-36)
...
resetSessionBtn:SetPoint("TOPLEFT",fontSL,"BOTTOMLEFT",0,-28)
...
scaleSL:SetScript("OnValueChanged",function(self,val) XPBuddyDB.scale=tonumber(string.format("%.2f",val));ApplyAppearance() end)
...
loader:SetScript("OnEvent",function()
  Reanchor();ApplyAppearance();UpdateTexts();f:Show()
end)
